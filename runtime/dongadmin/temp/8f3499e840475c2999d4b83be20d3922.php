            ...
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
              ...
              <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="radio" name="ishot" value="1"> <label for="checkbox-pinglun">是</label>&nbsp;&nbsp;
                    <input type="radio" name="ishot" value="0" checked> <label for="checkbox-pinglun">否</label>&nbsp;&nbsp;
                  </div>
                </div>
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                      <select name="cate_id" class="public_select">
                          ...
                          <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($cate_id == $vo['id']): ?>selected<?php endif; ?>><?php echo str_repeat('-', 5*$vo['cate_level']); ?><?php echo htmlentities($vo['cate_name']); ?></option>
