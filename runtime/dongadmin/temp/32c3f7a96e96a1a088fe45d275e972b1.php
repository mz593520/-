          ...
          <form class="layui-form" action="" method="post">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <input type="radio" name="ishot" value="1" <?php if($archivesData['ishot'] == 1): ?>checked<?php endif; ?>> <label for="checkbox-pinglun">是</label>&nbsp;&nbsp;
                    <input type="radio" name="ishot" value="0" <?php if($archivesData['ishot'] == 0): ?>checked<?php endif; ?>> <label for="checkbox-pinglun">否</label>&nbsp;&nbsp;
                  </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      ...
                      <div class="public_thumb_box" <?php if($archivesData['thumb']): ?>style="display:block"<?php endif; ?> attr-model="archives">
                        <input type="text" name="thumb" value="<?php echo htmlentities($archivesData['thumb']); ?>" class="public_thumb_input layui-input" style="width: 500px">
                        <img src="<?php echo htmlentities($archivesData['thumb']); ?>" class="public_thumb" width="150">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="url" class="layui-input" value="<?php echo htmlentities($archivesData['url']); ?>">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="keywords" class="layui-input" value="<?php echo htmlentities($archivesData['keywords']); ?>">
                    </div>
                  </div>
                  <div class="layui-form-item">
                    <label class="layui-form-label">SEO描述</label>
                    <div class="layui-input-block">
                      <textarea name="description" class="layui-textarea"><?php echo htmlentities($archivesData['description']); ?></textarea>
                    </div>
                  </div>
