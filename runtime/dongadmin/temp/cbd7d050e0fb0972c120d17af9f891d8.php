<?php /*a:5:{s:80:"E:\phpstudy\phpstudy_pro\WWW\www.study.com\app\dongadmin\view\category\edit.html";i:1585990302;s:78:"E:\phpstudy\phpstudy_pro\WWW\www.study.com\app\dongadmin\view\public\meta.html";i:1574502318;s:78:"E:\phpstudy\phpstudy_pro\WWW\www.study.com\app\dongadmin\view\public\left.html";i:1585273681;s:77:"E:\phpstudy\phpstudy_pro\WWW\www.study.com\app\dongadmin\view\public\top.html";i:1585963081;s:78:"E:\phpstudy\phpstudy_pro\WWW\www.study.com\app\dongadmin\view\public\foot.html";i:1585986026;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-tab-item layui-show">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="cate_name" class="layui-input" value="<?php echo htmlentities($categoryData['cate_name']); ?>">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-block">
                        <input type="text" name="link" class="layui-input" value="<?php echo htmlentities($categoryData['link']); ?>" >
                      </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-block">
                        ...
                        <div class="public_thumb_box" <?php if($categoryData['thumb']): ?>style="display: block"<?php endif; ?> attr-model="category">
                          <input type="text" name="thumb" value="<?php echo htmlentities($categoryData['thumb']); ?>" class="public_thumb_input layui-input" style="width: 500px">
                          <img src="<?php echo htmlentities($categoryData['thumb']); ?>" class="public_thumb" width="150">
                  ...
                  <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-block">
                        <input type="text" name="seo_title" class="layui-input" value="<?php echo htmlentities($categoryData['seo_title']); ?>">
                      </div>
                    </div>
                    <div class="layui-form-item">
                      <label class="layui-form-label">SEO关键词</label>
                      <div class="layui-input-block">
                        <input type="text" name="seo_keywords" class="layui-input" value="<?php echo htmlentities($categoryData['seo_keywords']); ?>">
                      </div>
                    </div>
                    <div class="layui-form-item">
                      <label class="layui-form-label">SEO描述</label>
                      <div class="layui-input-block">
                        <textarea name="seo_description" class="layui-textarea"><?php echo htmlentities($categoryData['seo_description']); ?></textarea>
                      </div>
                    </div>
                  ...
                  <div class="layui-tab-item">
                      <script id="editor" type="text/plain" name="content" style="width:100%;height:300px;"><?php echo $categoryData['content']; ?></script>
                  </div>
